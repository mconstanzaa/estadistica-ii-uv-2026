---
title: "Taller 10: Muestreo II en R"
...
💾 **Paso 2:** Movemos el archivo **"Script Taller 10 EstadisticaII.R"** a la carpeta `scripts`
...
💡 ¡Hoy seguimos con **diseño muestral** en R!

## Actividades prácticas

A lo largo de la clase realizaremos **dos actividades prácticas**, una por tipo de muestreo.
...
```{r echo=TRUE}
# Actividades Taller 10 Estadística II --------------------------------------------
...
> En este taller implementamos en R: **estratificado** y **conglomerados**.
:::
...
3.  Ordena la base por `zona_u_r` con `arrange()`,  fija la semilla con `set.seed(1234)` y extrae una muestra estratificada con `strata()` usando los tamaños que calculaste.
...
1. Fija la semilla con `set.seed(1234)` y selecciona **4 macro-zonas** al azar con `cluster()` usando `region_3` como conglomerado.
